...
const getStoresByName = async (partialName, mallname) => {
    ...
    return await AzrieliStore.find({ storename: { $regex: regex }, mallname: mallname });
};
...
module.exports = { createStore, getStoresByFloor, getStoresByName, deleteStoreByName, updateFloor }